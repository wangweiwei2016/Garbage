...
//        mContext = MainActivity5.this;
//        mData = new LinkedList<Data>();
//        empty_textview = (TextView) findViewById(R.id.txt_empty);
//        if(mData.size()>0)
//        {
//            bindViews();
...
//        }
//        else{
//            empty_textview.setText("暂无数据");
//            list_one.setEmptyView(empty_textview);
//        }
...
private void bindViews() {
    ...
    myAdadpter = new MyAdapter2<Hero>(mData,R.layout.item_spin_hero) {
        @Override
